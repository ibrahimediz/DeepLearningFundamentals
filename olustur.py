...
# os.mkdir("Egzersiz")
fileName = "03_04_MultiLabelClass.ipynb"
...
for item in liste:
    ...
    srcPath = "/workspace/DeepLearningFundamentals/Dokumanlar/03_DeepLearning/data/irrigation_machine.csv"
    destPath = fr"/workspace/DeepLearningFundamentals/Egzersiz/{item}/data/irrigation_machine.csv"
